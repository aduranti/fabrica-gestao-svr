      ...
      schemas: {
        ...
        Usuario: {
          ...
          properties: {
            ...
            perfil: { type: 'string', enum: ['super_admin', 'admin', 'operador', 'comprador'] },
            ativo: { type: 'boolean' },
        ...
        Tenant: {
          ...
          properties: {
            ...
            telefone: { type: 'string' },
            slug: { type: 'string' },
            plano: { type: 'string', enum: ['trial', 'basico', 'profissional'] },
            ativo: { type: 'boolean' },
            trial_expira: { type: 'string', format: 'date' },
            created_at: { type: 'string', format: 'date-time' },
          },
        },
        TenantInput: {
          type: 'object',
          required: ['tipo', 'nome', 'email_contato', 'admin_nome', 'admin_email', 'admin_senha'],
          properties: {
            tipo: { type: 'string', enum: ['pf', 'pj'], example: 'pj' },
            documento: { type: 'string', example: '12345678000195' },
            nome: { type: 'string', example: 'Cosméticos da Maria LTDA' },
            nome_fantasia: { type: 'string', example: 'Marca Maria' },
            email_contato: { type: 'string', format: 'email', example: 'contato@marca.com' },
            telefone: { type: 'string', example: '11999998888' },
            plano: { type: 'string', enum: ['trial', 'basico', 'profissional'], default: 'trial' },
            trial_expira: { type: 'string', format: 'date', nullable: true },
            admin_nome: { type: 'string', example: 'Maria Silva' },
            admin_email: { type: 'string', format: 'email', example: 'maria@marca.com' },
            admin_senha: { type: 'string', minLength: 6, example: 'senha123' },
          },
        },
        // Registro público
        RegisterPFInput: {
          type: 'object',
          required: ['tipo', 'cpf', 'nome', 'email_contato', 'admin_nome', 'admin_email', 'admin_senha'],
          properties: {
            tipo: { type: 'string', enum: ['pf'], example: 'pf' },
            cpf: { type: 'string', minLength: 11, maxLength: 11, example: '12345678901' },
            nome: { type: 'string', example: 'Maria Silva' },
            email_contato: { type: 'string', format: 'email', example: 'maria@email.com' },
            telefone: { type: 'string', example: '11999998888' },
            admin_nome: { type: 'string', example: 'Maria Silva' },
            admin_email: { type: 'string', format: 'email', example: 'maria@email.com' },
            admin_senha: { type: 'string', minLength: 6, example: 'senha123' },
          },
        },
        RegisterPJInput: {
          type: 'object',
          required: ['tipo', 'cnpj', 'razao_social', 'email_contato', 'admin_nome', 'admin_email', 'admin_senha'],
          properties: {
            tipo: { type: 'string', enum: ['pj'], example: 'pj' },
            cnpj: { type: 'string', minLength: 14, maxLength: 14, example: '12345678000195' },
            razao_social: { type: 'string', example: 'Cosméticos da Maria LTDA' },
            nome_fantasia: { type: 'string', example: 'Marca Maria' },
            email_contato: { type: 'string', format: 'email', example: 'contato@marca.com' },
            telefone: { type: 'string', example: '11999998888' },
            admin_nome: { type: 'string', example: 'Maria Silva' },
        ...
        LogAuditoria: {
          ...
          properties: {
            ...
            acao: { type: 'string', enum: ['login', 'logout', 'login_falhou', 'criar', 'atualizar', 'deletar', 'confirmar', 'cancelar', 'restaurar', 'exportar'] },
            entidade: { type: 'string', example: 'Venda' },
